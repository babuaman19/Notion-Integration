...
```bash
git clone git clone https://amir_khan3@bitbucket.org/vebuin/jugaad-copilot.git
cd jugaad-copilot
```
...
This will start both the FastAPI application and Weaviate in containers with proper networking.

### Running Locally

1. Start Connecting with Cloud Weaviate
